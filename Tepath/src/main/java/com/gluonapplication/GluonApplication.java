...
/**
 * Diese Klasse organisiert die verschiedenen Ansichten. Sie ist die Hauptklasse
 * in der alle Ansichten definiert werden. Es können hier neue definiert werden
...
public class GluonApplication extends MobileApplication {
	...
	public static final String PRIMARY_VIEW = HOME_VIEW; // primaryView ist die
															// Startseite
	public static final String SECONDARY_VIEW = "Ablauf"; // secondaryView ist
															// die Ablaufseite
	public static final String MENU_LAYER = "Side Menu";
	public static final String CHECKLIST_VIEW = "Checklisten"; // die Sicht mit
																// den
																// Checklisten
	...
	public static final String CHECKLISTESPITALEINTRITT_VIEW = "Spitaleintritt";// Checkliste
																				// vor
																				// Spitaleintritt
	public static final String CHECKLISTESPEZIALISTENBESUCH_VIEW = "Spezialistenbesuch";// Chekliste
																						// vor
																						// Speizalistenbesuch
	public static final String CHECKLISTEREHAEINTRITT_VIEW = "Rehaeintritt";// Checkliste
																			// vor
																			// Rehaeintritt
	public static final String HAUSARZTKONTAKT1_VIEW = "Hausarztkontakt1";// Kontakt
																			// _Hausazrt
	...
	public void init() {
		...
		// Das Menu wird auch hier erstellt. Das Menu wird auf der linken Seite
		// eingeblendet.
		...
		addViewFactory(CHECKLISTESPEZIALISTENBESUCH_VIEW,
				() -> new ChecklisteSpezialistenbesuchView(CHECKLISTESPEZIALISTENBESUCH_VIEW).getView());
		addViewFactory(CHECKLISTEREHAEINTRITT_VIEW,
				() -> new ChecklisteRehaeintrittView(CHECKLISTEREHAEINTRITT_VIEW).getView());
