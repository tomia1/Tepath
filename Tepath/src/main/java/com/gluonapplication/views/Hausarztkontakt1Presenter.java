...
public class Hausarztkontakt1Presenter {
	...
	/**
	 * Es wird der Name, Adresse und Telefonnummer des Hausarztes aus der
	...
	public void initialize() {
		...
		try {
			...
			String query3 = "SELECT dbo.Hausarzt.Name, dbo.Hausarzt.Adresse, "
					...
					+ "dbo.Patienten ON dbo.Hausarzt.ID_Hausarzt = " + "dbo.Patienten.Hausarzt"
		...
		/**
		 * Die ApplikationsBar beinhaltet die Ueberschrift "Hausarzt" sowie das
