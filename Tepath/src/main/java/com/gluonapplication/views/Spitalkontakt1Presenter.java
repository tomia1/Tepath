...
/**
 * Diese Klasse beinhaltet die Darstellung der Kontaktinformationen des Spitals.
 * 
 * @author Hager
 *
 */
public class Spitalkontakt1Presenter {
	...
	/**
	 * Es wird der Name, Adresse und Telefonnummer des Spitals aus der Datenbank
	...
	public void initialize() {
		...
		try {
			...
			String query3 = "SELECT dbo.Spital.Name, dbo.Spital.Adresse, "
					+ "dbo.Spital.Telefon FROM dbo.Spital INNER JOIN " + "dbo.Patienten ON dbo.Spital.ID_Spital = "
					+ "dbo.Patienten.Spital" + " Where (dbo.Patienten.ID_Patient =" + PatientID + ")";
		...
		/**
		 * Die ApplikationsBar beinhaltet die Ueberschrift "Spital" sowie das
